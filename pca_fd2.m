function pcastr = pca_fd2(fdobj, nharm, harmfdPar, centerfns)
...
Jmat = inprod_basis2(harmbasis, fdbasis); % AMENDED
MIJW = Mmatinv'*Jmat;
...
if nvar == 1
    harmscr = inprod(fdobj, harmfd); %KEEP ORIGINAL VERSION
else
    ...
    for j=1:nvar
        ...
        harmscr(:,:,j) = inprod(fdobjj,harmfdj); %KEEP ORIGINAL VERSION
    end
end
